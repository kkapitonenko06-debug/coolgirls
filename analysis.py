...
def build_staff_costs() -> pd.DataFrame:
    staff = pd.DataFrame(
        [
            {"position": "Бариста", "headcount": 3, "monthly_salary_rub": 70000, "schedule": "2/2"},
            {"position": "Кассир", "headcount": 2, "monthly_salary_rub": 60000, "schedule": "2/2"},
            {"position": "Администратор смены", "headcount": 1, "monthly_salary_rub": 85000, "schedule": "5/2"},
        ]
    )
